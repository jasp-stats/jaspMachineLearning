...
test_that("Evaluation Metrics table results match", {
	...
	jaspTools::expect_equal_tables(table,
		list(1, 1, 1, 0, 0, 0, 0, "setosa", 1, 1, 1, 0.333333333333333, 10,
			 1, "<unicode><unicode><unicode>", 0.933333333333333, 0.954545454545454,
			 ...
			 0.1, 0, "virginica", 0.9, 1, 0.833333333333333, 0.333333333333333,
			 12, 1, 5, 0.955555555555556, 0.957070707070707, 0.934006734006734,
			 0.0666666666666667, 0.0555555555555556, 0.0333333333333333,
			 0.0303030303030303, "Average / Total", 0.966666666666667, 0.946666666666667,
			 0.933333333333333, 1, 30, 0.96969696969697, "<unicode><unicode><unicode>"
			))
})