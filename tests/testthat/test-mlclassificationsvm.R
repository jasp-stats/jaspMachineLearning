...
test_that("Evaluation Metrics table results match", {
	...
	jaspTools::expect_equal_tables(table,
		list(1, 1, "setosa", 1, 1, 10, 0.551136363636364, 0.941176470588235,
			 "versicolor", 0.888888888888889, 1, 8, 0.958333333333333, 0.956521739130435,
			 "virginica", 1, 0.916666666666667, 12, 0.836489898989899, 0.96692242114237,
			 "Average / Total", 0.97037037037037, 0.966666666666667, 30
			))
})