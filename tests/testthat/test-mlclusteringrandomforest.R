...
test_that("All predictors plot matches", {
	...
	jaspTools::expect_equal_plots(testPlot, "all-predictors", dir="mlClusteringRandomForest")
})
...
test_that("Elbow Method Plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "elbow-method-plot", dir="mlClusteringRandomForest")
})
...
test_that("t-SNE Cluster Plot matches", {
  skip("Does not reproduce on windows <-> osx")
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "t-sne-cluster-plot", dir="mlClusteringRandomForest")
})