...
- Parameter estimates: Shows tables containing the model parameters for each cluster and feature variable.
...
- Model: Choose the model type to be fitted in the EM step of the clustering. The 'Auto' option automatically determines the best fitting model type. The following models are included:
