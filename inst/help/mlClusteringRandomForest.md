...
- Feature importance: Shows the feature importance in decreasing order. The Gini index calculates the importance as the sum over the number of splits that include a particular variable, proportionally to the number of samples this variable splits.
...
- Feature Importance: Shows the importance of each feature in decreasing order.
