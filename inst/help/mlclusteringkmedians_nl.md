...
K-medians is een clusteringalgoritme vergelijkbaar met k-means. In tegenstelling tot het k-means-algoritme, kiest k-medians de medians als centra, en zorgt daardoor voor andere interpreteerbaarheid van de clustercentra dan in k-means.
