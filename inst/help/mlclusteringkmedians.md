...
K-medians is a clustering algorithm similar to k-means. In contrast to the k-means algorithm, k-medians chooses the medians as centers, and thereby allows for different interpretability of the cluster centers than in k-means.
