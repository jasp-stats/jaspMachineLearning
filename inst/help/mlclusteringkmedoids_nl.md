...
K-medoids is een clusteringalgoritme vergelijkbaar met k-means. In tegenstelling tot het k-means-algoritme, kiest k-medoids werkelijke datapunten als centra (medoïden of voorbeelden), en zorgt daardoor voor een grotere interpreteerbaarheid van de clustercentra dan in k-means.
...
- Medoïden: Toont de medoïde per variabele van elke cluster, wat staat voor het gemiddelde van een cluster.
...
#### K-medoide Clustering Model Tabel
